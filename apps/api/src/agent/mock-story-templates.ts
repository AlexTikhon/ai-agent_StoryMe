import type { ChapterOutline } from '@book/types';
...
export function chapterTemplatesFor(
...
export const STRINGS_BY_LANGUAGE: Record<TemplateLanguage, LocalizedStrings> = {
  en: {
