...
// Prisma emits string enum values that match the schema — 'created', 'page_plan', etc.
const STATUS_CREATED = 'created' as Book['status'];
const STATUS_IN_PROGRESS = 'page_plan' as Book['status'];
...
describe('BooksService', () => {
  ...
  describe('startGeneration', () => {
    it('starts generation and returns GenerateBookResponse on success', async () => {
      ...
      expect(result.book.status).toBe('page_plan');
